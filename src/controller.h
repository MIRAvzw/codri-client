...
namespace MIRA
{
    ...
    private slots:
        ...
        void _loadInterface(QString iInterfaceIdentifier, QString iInterfaceRole, QString iInterfaceLocation);
        void _loadMedia(QString iMediaIdentifier, QString iMediaLocation);
